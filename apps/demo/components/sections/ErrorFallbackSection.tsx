        ...
        <CardContent>
          <Stack spacing={1}>
            <Typography variant='body2'>
              errorFallback은 권한 거부, 카메라 없음, 브라우저 미지원, 보안 컨텍스트 오류 같은 error
              계열 phase에서 렌더링됩니다.
            </Typography>
            <Typography variant='body2' color='text.secondary'>
              fallback 함수는 WebcamDetail을 받아 errorCode별 메시지와 CTA를 다르게 구성할 수
              있습니다. playback-error는 스트림이 살아 있는 재생 실패라서 이 fallback 대상이
              아닙니다.
            </Typography>
          </Stack>
        </CardContent>
