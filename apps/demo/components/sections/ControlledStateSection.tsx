    ...
    <Box>
      <Stack spacing={3} direction='column'>
            ...
            <Stack spacing={2}>
              ...
              <Alert severity='success' variant='outlined'>
                ...
                <Typography variant='body2' gutterBottom>
                  ...
                  함께 전달하는 방식입니다. 버튼 클릭 시 <code>onFlippedChange</code>가 호출되어
                  부모 state를 갱신합니다.
                </Typography>
                <Typography variant='body2'>
                  콜백을 생략하면 읽기 전용 controlled로도 쓸 수 있지만, 내부 토글은 부모가
                  반영해줘야 바뀝니다.
                </Typography>
              </Alert>
            </Stack>
        ...
        <ExampleCard title='읽기 전용 controlled 예제'>
          ...
          <Typography variant='body2' color='text.secondary' sx={{ mt: 1 }}>
            <code>flipped</code>만 전달하고 <code>onFlippedChange</code>를 생략하면 내부 토글은
            반영되지 않고, 부모가 바꿔줄 때만 화면이 갱신됩니다.
          </Typography>
          <Button
            variant='outlined'
            size='small'
